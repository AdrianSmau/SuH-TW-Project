...
function increment() {
    var score = parseInt(scoretext.getAttribute("data-score"));
    if (score < 35) {
        var new_score = score + 5;
        if (new_score < 35) {
            scoretext.setAttribute("data-score", new_score);
            scoretext.innerText = new_score + "/35";
            fill(new_score, 35);
        } else {
            scoretext.setAttribute("data-score", 35);
            scoretext.innerText = "35/35";
            fill(35, 35);
        }
    } else {
        var new_score = 0;
        scoretext.setAttribute("data-score", 0);
